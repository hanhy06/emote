...
class EmoteMatrixNormalizerTest {
    @Test
    void removesShearAndPreservesTranslation() {
        EmoteAnimation.Matrix result = EmoteMatrixNormalizer.stabilize(matrix(List.of(
    ...
    void retainsAlreadyStableTrsMatrix() {
        ...
        assertSame(matrix, EmoteMatrixNormalizer.stabilize(matrix));
    }
