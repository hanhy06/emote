...
class EmoteAnimationServerValidatorTest {
    ...
    void rejectsSkinMetadataOnNonPlayerHeadItem() {
        ...
        EmoteAnimationLoadException exception = assertThrows(
            ...
            () -> EmoteAnimationServerValidator.validateSkinTarget(
    ...
    void acceptsNonPlayerHeadItemWithoutSkinMetadata() {
        assertDoesNotThrow(() -> EmoteAnimationServerValidator.validateSkinTarget(
