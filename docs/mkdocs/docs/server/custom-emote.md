...
!!! note "Polymer is optional"
    The emotes bundled with Emote do not require a resource pack.<br>If none of your custom emotes use a `*.resources.zip` file, you can disable Polymer integration.
