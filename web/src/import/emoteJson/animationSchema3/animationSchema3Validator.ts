...
export interface Schema3ValidationIssue {
  path: string;
  message: string;
}

export function validateSchema3Animation(animation: Schema3EmoteAnimation): Schema3ValidationIssue[] {
  const issues: Schema3ValidationIssue[] = [];
...
function validateCommon(animation: Schema3EmoteAnimation, issues: Schema3ValidationIssue[]): void {
...
function validateEvents(animation: Schema3EmoteAnimation, durationTicks: number | null, issues: Schema3ValidationIssue[]): void {
...
function validateEvent(event: EmoteEvent, path: string, animation: Schema3EmoteAnimation, issues: Schema3ValidationIssue[]): void {
...
function validateTime(value: string, minimumTicks: number, path: string, issues: Schema3ValidationIssue[]): number | null {
  try {
...
function add(issues: Schema3ValidationIssue[], path: string, message: string): void {
